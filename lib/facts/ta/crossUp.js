...
class CrossUp extends Fact {
  ...
  get schema () {
    return {
      ...
      confirmationCountMin: { type: 'number', optional: true, default: 0, min: 0, convert: true, description: 'Minimum confirmation candles above.' },
      confirmationCountMax: { type: 'number', optional: true, default: 0, min: 0, convert: true, description: 'Maximum confirmation candles above.' },
      $$strict: 'remove'
    }
  }
  ...
  async value (params = {}) {
    ...
    const results = techIndicators.crossUp({ lineA: series1, lineB: series2 })
