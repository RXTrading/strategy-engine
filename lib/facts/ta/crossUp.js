...
class CrossUp extends Fact {
  ...
  get schema () {
    return {
      series1: { type: 'array', items: { type: 'number', convert: true }, optional: true, default: [] },
      series2: { type: 'array', items: { type: 'number', convert: true }, optional: true, default: [] },
      confirmationCountMin: { type: 'number', optional: true, default: 0, min: 0 },
      confirmationCountMax: { type: 'number', optional: true, default: 0, min: 0 },
      $$strict: 'remove'
    }
  }
